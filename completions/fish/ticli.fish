...
complete -c ticli -n "__fish_use_subcommand" -f -a "incr" -d 'Increase the specified kye by one'
complete -c ticli -n "__fish_use_subcommand" -f -a "decr" -d 'Decrease the specified kye by one'
