...
complete -c ticli -n "__fish_use_subcommand" -f -a "incr" -d 'Increments the number stored at key by one'
complete -c ticli -n "__fish_use_subcommand" -f -a "incrby" -d 'Increments the number stored at key by increment'
complete -c ticli -n "__fish_use_subcommand" -f -a "decr" -d 'Decrements the number stored at key by one'
complete -c ticli -n "__fish_use_subcommand" -f -a "decrby" -d 'Decrements the number stored at key by decrement'
...
complete -c ticli -n "__fish_seen_subcommand_from incr" -s h -l help -d 'Print help information'
complete -c ticli -n "__fish_seen_subcommand_from incrby" -s h -l help -d 'Print help information'
complete -c ticli -n "__fish_seen_subcommand_from decr" -s h -l help -d 'Print help information'
complete -c ticli -n "__fish_seen_subcommand_from decrby" -s h -l help -d 'Print help information'
